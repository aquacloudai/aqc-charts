...
const StackedBarChart = forwardRef(({ data, horizontal = false, showPercentage = false, showValues = false, barWidth = "60%", barMaxWidth, stackName = "total", showLegend = true, legend, tooltip, xAxis, yAxis, grid, series: customSeries,...props }, ref) => {
	const series = useMemo(() => {
		if (customSeries) return customSeries;
...
const GanttChart = forwardRef(({ data, heightRatio = .6, showDataZoom = true, draggable: _draggable = false, showLegend = false, legend, tooltip, xAxis, yAxis, grid, onTaskDrag: _onTaskDrag,...props }, ref) => {
...
//#endregion
export { BarChart, BaseChart, CalendarHeatmapChart, ClusterChart, GanttChart, LineChart, PieChart, RegressionChart, SankeyChart, ScatterChart, StackedBarChart, clusterPointsToScatterData, darkTheme, extractPoints, lightTheme, performKMeansClustering, useECharts };