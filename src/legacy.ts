 ...
 *
 * @deprecated These components use the old API and will be removed in a future major version.
 * Please migrate to the new ergonomic components (LineChart, BarChart, etc.).
 *
 * Import from '@aquacloud_ai/aqc-charts/legacy' if you still need these components.
 */
